  ...
  return (
    ...
    {/* Icons */}
        <div className='flex space-x-4 gap-4  text-2xl'> 
          ...
          <a href='https://www.alljobs.co.il/user/profile/full-profile' target='_blank' className=' cursor-pointer hover:translate-y-1 transition-transform duration-300'><SmallIcon/></a>
        </div>
    </motion.nav>
  )
}
